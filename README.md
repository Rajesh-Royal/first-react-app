      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class=" color-danger" aria-hidden="true"><img class="App-logo" src="images/react.png" width="25px" hight="25px"/></i> by <a href="http://rajeshroyal.rf.gd" target="_blank">Rajesh</a>
